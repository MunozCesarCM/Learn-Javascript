  ...
  return (
    <main className='topic-overview'>
      <article>
        ...
        <section>
          <h2>Section 01</h2>
          <Card title='Introduction to Variables' />
          <Card title='Assign a value to a variable' type='Practice' />
          <Card title='Assign a value to a new variable' type='Practice' />
          <Card title='Create the missing variable' type='Practice' />

          <h2>Section 02</h2>
          <Card title='Working with Constants' />
          <Card title='Accessing a constant' type='Practice' />
