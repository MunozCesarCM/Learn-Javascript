export const jsBasicsContent = {
  ...
  'javascript-types': [
    [
      { type: 'question',
        title: 'In JavaScript, every value is either an object or a primitive data type.',
        questions: [
          'True',
          'False',
        ],
    ...
    [
      { type: 'question',
        ...
        questions: [
          'It assigns a specific data type to a variable.',
          'It converts a value to a specific data type.',
          'It checks if a variable is null or undefined.',
          'It retrieves the current type of a value.',
        ],
        correctIndex: 4,
        required: true,
      },
  ...
  'even-more-types': [
    [
      { type: 'question',
        title: 'JavaScript has separate data types for integers and floating-point numbers',
        questions: [
          'true',
          'false',
        ],
    ...
    [
      { type: 'question',
        title: 'What value does an uninitialized variable have in JavaScript?',
        questions: [
          'null',
          'undefined',
          'NaN',
    ...
    [
      { type: 'question',
        title: 'What is the result of the following code: ##console.log(NaN == NaN);##?',
        questions: [
          'NaN',
          'true',
          'false',
